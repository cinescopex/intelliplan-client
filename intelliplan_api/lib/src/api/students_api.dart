...
class StudentsApi {
  ...
  const StudentsApi(this._dio, this._serializers);
  ...
  /// Returns a [Future] containing a [Response] with a [StudentResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StudentResponse>> apiV1StudentsPost({ 
    AddOrUpdateStudentRequest? addOrUpdateStudentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<StudentResponseCollectionBaseResponse>> apiV1StudentsStudentIdDelete({ 
    ...
    final _path = r'/api/v1/Students/{studentId}'.replaceAll('{' r'studentId' '}', studentId.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
